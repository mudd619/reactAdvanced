...
export function Others(){
    ...
    const {setLoading,setError,data3} = useSelector((state)=>state.todo.todo);
    ...
    return setLoading ? "...loading" : setError ? "Something Went Wrong" : 
        <div style={{backgroundColor:"#a6edfa",margin:"2% 35% 5% 35%",position:"relative",left:"7%",padding:"1%",paddingBottom:"3%"}}>
            <h2 >Others</h2>
            <div style={{marginTop:"10%"}}>{data3.map((el)=>{
