...
export function All(){
    ...
    const {setLoading,setError,data} = useSelector((state)=>state.todo.todo);
    ...
    return setLoading ? "...loading" : setError ? "Something Went Wrong" : 
        <div style={{backgroundColor:"#f5c9e4",margin:"2% 35% 5% 35%",position:"relative",left:"7%",padding:"1%",paddingBottom:"3%"}}>
            <h2 >All Tasks</h2>
            <div style={{marginTop:"10%"}}>{data.map((el)=>{
